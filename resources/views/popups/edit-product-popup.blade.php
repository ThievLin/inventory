...
<div id="editPopup" class="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 hidden">
    <div class="bg-white rounded-lg w-1/2">
        ...
        <form id="editProductPopup"  action="" method="POST" enctype="multipart/form-data" class="p-6">
            ...
            <div class="mb-4">
                <label for="editPro_name_eng" class="block text-sm font-medium text-gray-900 mb-1">NAME IN ENGLISH</label>
            ...
            <div class="mb-4">
                <label for="editPro_name_kh" class="block text-sm font-medium text-gray-900 mb-1">NAME IN KHMER</label>
